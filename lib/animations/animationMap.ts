const animationMap: { [key: string]: any } = {
  "/images/scanIcon.svg": require("./scanAnimation.json"),
  "/images/privateInfoIcon.svg": require("./privateInfoAnimation.json"),
  "/images/keyIcon.svg": require("./keyAnimation.json"),
  "/images/cameraIcon.svg": require("./cameraAnimation.json"),
