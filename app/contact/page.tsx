...
export default function Contact() {
  ...
  if (step === 2) {
    return (
      <div className={styles.step2_container}>
        ...
        {/* Hadas added for check if step 4 works */}
        <div className={styles.buttonContainer}>
          <button className={styles.button_step_1} onClick={handleSendedButton}>
            תודה, מעדיף להישאר אנונימי
            </button>
        </div>
      </div>
  ...
  if(step === 3){
    return (
      <div className={`${styles.step1_container} ${styles.step3_container}`}>
        <div className={styles.header_step_1}> 
        <svg width="89" height="115" viewBox="0 0 89 115" fill="none" xmlns="http://www.w3.org/2000/svg">
          <g clip-path="url(#clip0_1125_144)">
        ...
        <div className={`${styles.subHeader_step_1} ${styles.step3_text_color}`}>
        העברתי את המספר שלך,<br /> בקרוב יחזרו אליך
        </div>
        <div className={`${styles.paragraph_step_1} ${styles.step3_text_color}`}>
        ...
        <div className={styles.buttonContainer}>
          <button className={`${styles.button_step_1} ${styles.button_step_3}`} onClick={handleAnonimusButton}>
          הבנתי, אפשר להמשיך
          </button>
        </div>
      </div>
